...
order by 1,2;"""
        ...
        groups = {
            'Randomizer parameters': [
                'logic', 'preset', 'startLocation', 'majorsSplit', 'scavNumLocs', 'scavRandomized',
                'progressionSpeed', 'maxDifficulty', 'morphPlacement', 'progressionDifficulty', 'suitsRestriction',
                'hideItems', 'objective', 'nbObjective', 'nbObjectivesRequired', 'hiddenObjectives',
                'distributeObjectives', 'tourian'],
            'Ammo and Energy': ['minorQty', 'minorQtyEqLeGe', 'energyQty', 'strictMinors', 'missileQty',
                                'superQty', 'powerBombQty'],
            'Areas and Fun': [
                'areaRandomization', 'areaLayout', 'doorsColorsRando', 'allowGreyDoors', 'bossRandomization',
                'minimizer', 'minimizerQty', 'escapeRando', 'removeEscapeEnemies', 'funCombat', 'funMovement',
                'funSuits'],
            'Patches': [
