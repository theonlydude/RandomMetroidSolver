...
[ -L ~/web2py/applications/solver/static/images/backup_saves.png ] || ln -s ~/RandomMetroidSolver/web/static/backup_saves.png ~/web2py/applications/solver/static/images/backup_saves.png
