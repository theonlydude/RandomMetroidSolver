...
patches = {
    ...
    'Blinking[Crocomire Room Top]': {
        ...
        "bank_8f_Door_4F_Room_A98D_PLM_C854": [0x54, 0xc8, 0x46, 0x02, 0x4f, 0x8c],
    ...
    'Save_G4': {
        ...
        snes_to_pc(0x80c527): [0xed, 0xa5, 0x16, 0x92, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0xa8, 0x0, 0xa0, 0xff],
        # map icon X/Y
        snes_to_pc(0x82c86f): [0x78, 0x1, 0x48, 0x0],
    },
    'Save_Gauntlet': {
        # 0x80c519 load point entry - x/y updated
        snes_to_pc(0x80c519): [0xbd, 0x99, 0x1a, 0x8b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x88, 0x0, 0xb0, 0xff],
        # music in room state header
        snes_to_pc(0x8f99ce): [0x9],
        # map icon X/Y
        snes_to_pc(0x82c86b): [0x98, 0x1, 0x18, 0x0],
    },
    'Save_Watering_Hole': {
        # 0x80c979 load point entry - x/y updated
        snes_to_pc(0x80c979): [0x3b, 0xd1, 0x98, 0xa4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x88, 0x0, 0x30, 0x0],
        # music in room state header
        snes_to_pc(0x8fd14c): [0x1b, 0x6],
        # map icon X/Y
        snes_to_pc(0x82ca0f): [0xa8, 0x1, 0x28, 0x0],
    },
    'Save_Mama': {
        # 0x80c96b load point entry - x/y updated
        snes_to_pc(0x80c96b): [0x55, 0xd0, 0xe4, 0xa3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x98, 0x0, 0x10, 0x0],
        # music in room state header
        snes_to_pc(0x8fd066): [0x1b, 0x6],
        # map icon X/Y
        snes_to_pc(0x82ca0b): [0x79, 0x1, 0x67, 0x0],
    },
    'Save_Aqueduct': {
        # 0x80c95d load point entry - x/y updated
        snes_to_pc(0x80c95d): [0xa7, 0xd5, 0xd4, 0xa7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x78, 0x0, 0xe0, 0xff],
        # map icon X/Y
        snes_to_pc(0x82ca07): [0x48, 0x1, 0x50, 0x0],
    },
    'Save_Etecoons': {
        # 0x80c631 load point entry - x/y updated
        snes_to_pc(0x80c631): [0x51, 0xa0, 0x3a, 0x8f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x98, 0x0, 0x30, 0x0],
        # music in room state header
        snes_to_pc(0x8fa062): [0xf, 0x5],
        # map icon X/Y
        snes_to_pc(0x82c8d9): [0xd0, 0x1, 0x58, 0x0],
    },
    'Save_Firefleas': {
        # 0x80c73b load point entry - x/y updated
        snes_to_pc(0x80c73b): [0x5a, 0xb5, 0x9e, 0x9a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x78, 0x0, 0x0, 0x0],
        # music in room state header
        snes_to_pc(0x8fb56b): [0x18, 0x5],
        # map icon X/Y
        snes_to_pc(0x82c93f): [0xc8, 0x0, 0x38, 0x0],
    },
    'Save_Crab_Shaft': {
        # 0x80c995 load point entry - x/y updated
        snes_to_pc(0x80c995): [0xa3, 0xd1, 0x68, 0xa4, 0x0, 0x0, 0x0, 0x1, 0x0, 0x2, 0x78, 0x0, 0xa0, 0xff],
        # map icon X/Y
        snes_to_pc(0x82ca17): [0x80, 0x1, 0x50, 0x0],
    },
    'Save_Main_Street': {
        # 0x80c9a3 load point entry - x/y updated
        snes_to_pc(0x80c9a3): [0xc9, 0xcf, 0xd8, 0xa3, 0x0, 0x0, 0x0, 0x1, 0x0, 0x5, 0x78, 0x0, 0xf0, 0xff],
        # map icon X/Y
        snes_to_pc(0x82ca1b): [0xb8, 0x1, 0x78, 0x0],
    },
...
additional_PLMs = {
    ...
    'Save_G4': {
        'room': 0xa5ed,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x11, 0xc, 0x7, 0x0],
        ],
    },
    'Save_Gauntlet': {
        'room': 0x99bd,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x2, 0xa, 0x6, 0x0],
        ],
    },
    'Save_Watering_Hole': {
        'room': 0xd13b,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0xa, 0xa, 0x7, 0x0],
        ],
    },
    'Save_Mama': {
        'room': 0xd055,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x8, 0xb, 0x6, 0x0],
        ],
    },
    'Save_Aqueduct': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x5, 0x9, 0x5, 0x0],
        ],
    },
    'Save_Etecoons': {
        'room': 0xa051,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0xa, 0xb, 0x7, 0x0],
        ],
    },
    'Save_Firefleas': {
        'room': 0xb55a,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x7, 0x9, 0x7, 0x0],
        ],
    },
    'Save_Crab_Shaft': {
        'room': 0xd1a3,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x11, 0x29, 0x9, 0x0],
        ],
    },
    'Save_Main_Street': {
        'room': 0xcfc9,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x16, 0x59, 0xa, 0x0],
        ],
    },
    'Blinking[Moat Right]': {
        'room': 0x95ff,
