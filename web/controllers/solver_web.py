...
desc = {'Mockball': {'display': 'Mockball',
                     ...
                     'rooms': [('Early Supers Room', 'https://wiki.supermetroid.run/Early_Supers_Room'), ('Ice Beam Gate Room', 'https://wiki.supermetroid.run/Ice_Beam_Gate_Room')]},
        'SimpleShortCharge': {'display': 'Simple Short Charge',
                              ...
                              'rooms': [('Parlor and Alcatraz', 'https://wiki.supermetroid.run/Parlor_and_Alcatraz'), ('Waterway Energy Tank Room', 'https://wiki.supermetroid.run/Waterway_Energy_Tank_Room'), ('Landing Site', 'https://wiki.supermetroid.run/Landing_Site'), ('Crateria Keyhunter Room', 'https://wiki.supermetroid.run/Crateria_Keyhunter_Room')]},
        ...
        'GreenGateGlitch': {'display': 'Green Gate Glitch',
                            ...
                            'rooms': [('Grapple Tutorial Room 3', 'https://wiki.supermetroid.run/Grapple_Tutorial_Room_3'), ('Fast Ripper Room', 'https://wiki.supermetroid.run/Fast_Ripper_Room'), ('Upper Norfair Farming Room', 'https://wiki.supermetroid.run/Upper_Norfair_Farming_Room')]},
        'ShortCharge': {'display': 'Short Charge',
                        'title': 'To kill draygon',
                        'href': 'https://wiki.supermetroid.run/index.php?title=Short_Charge',
                        'rooms': [('Plasma Room', 'https://wiki.supermetroid.run/Plasma_Room'), ('Crateria Super Room', 'https://wiki.supermetroid.run/Crateria_Super_Room'), ("Draygon's Room", 'https://wiki.supermetroid.run/Draygon%27s_Room')]},
        'GravityJump': {'display': 'Gravity-Jump',
                        ...
                        'rooms': [("Draygon's Room", 'https://wiki.supermetroid.run/Draygon%27s_Room'), ('The Moat', 'https://wiki.supermetroid.run/The_Moat'), ('Lava Dive Room', 'https://wiki.supermetroid.run/Lava_Dive_Room'), ('Mt. Everest', 'https://wiki.supermetroid.run/Mt._Everest')]},
        'SpringBallJump': {'display': 'SpringBall-Jump',
                           ...
                           'rooms': [('Main Street', 'https://wiki.supermetroid.run/Main_Street'), ('Sponge Bath', 'https://wiki.supermetroid.run/Sponge_Bath'), ('Mama Turtle Room', 'https://wiki.supermetroid.run/Mama_Turtle_Room'), ('The Precious Room', 'https://wiki.supermetroid.run/The_Precious_Room')]},
        'SpringBallJumpFromWall': {'display': 'SpringBall-Jump from wall',
                                   'title': 'Exit Screw Attack area, climb Worst Room without Hi-Jump',
                                   'href': None,
                                   'rooms': [('Screw Attack Room', 'https://wiki.supermetroid.run/Screw_Attack_Room'), ('The Worst Room In The Game', 'https://wiki.supermetroid.run/The_Worst_Room_In_The_Game')]},
        'GetAroundWallJump': {'display': 'Get around Wall-Jump',
                              ...
                              'rooms': [('The Worst Room In The Game', 'https://wiki.supermetroid.run/The_Worst_Room_In_The_Game'), ('Bubble Mountain', 'https://wiki.supermetroid.run/Bubble_Mountain'), ('Plasma Room', 'https://wiki.supermetroid.run/Plasma_Room')]},
        'DraygonGrappleKill': {'display': 'Draygon Grapple Kill',
                               ...
                               'rooms': [("Draygon's Room", 'https://wiki.supermetroid.run/Draygon%27s_Room')]},
        ...
        'MicrowavePhantoon': {'display': 'Microwave Phantoon',
                              ...
                              'href': None,
                              'rooms': [("Phantoon's Room", 'https://wiki.supermetroid.run/Phantoon%27s_Room')]},
        'IceZebSkip': {'display': 'Ice Zeb Skip',
                       'title': 'Skip the Zebetites with Ice beam',
                       'href': 'https://www.youtube.com/watch?v=GBXi3MSpGZg',
                       'rooms': [('Mother Brain Room', 'https://wiki.supermetroid.run/Mother_Brain_Room')]},
        ...
        'AlcatrazEscape': {'display': 'Alcatraz Escape',
                           ...
                           'rooms': [('Parlor and Alcatraz', 'https://wiki.supermetroid.run/Parlor_and_Alcatraz')]},
        'ReverseGateGlitch': {'display': 'Reverse Gate Glitch',
                              ...
                              'rooms': [('Pink Brinstar Hopper Room', 'https://wiki.supermetroid.run/Pink_Brinstar_Hopper_Room')]},
        'ReverseGateGlitchHiJumpLess': {'display': 'Reverse Gate Glitch w/o Hi-Jump',
        ...
        'EarlyKraid': {'display': 'Early Kraid',
                       ...
                       'rooms': [('Warehouse Entrance', 'https://wiki.supermetroid.run/Warehouse_Entrance')]},
        'XrayDboost': {'display': 'X-Ray Damage Boost',
                       ...
                       'rooms': [('Red Brinstar Fireflea Room', 'https://wiki.supermetroid.run/Red_Brinstar_Fireflea_Room')]},
        ...
        'RedTowerClimb': {'display': 'Red Tower Climb',
                          ...
                          'rooms': [('Red Tower', 'https://wiki.supermetroid.run/Red_Tower')]},
        'HiJumpLessGauntletAccess': {'display': 'Gauntlet Access w/o Hi-Jump',
                                 'title': 'Access Gauntlet area using really tricky Wall-Jumps',
                                 'href': 'https://www.youtube.com/watch?v=uVU2X-egOTI&t=25s',
                                     'rooms': [('Landing Site', 'https://wiki.supermetroid.run/Landing_Site')]},
        ...
        'GauntletWithBombs': {'display': 'Gauntlet With Bombs',
                              ...
                              'rooms': [('Gauntlet Entrance', 'https://wiki.supermetroid.run/Gauntlet_Entrance')]},
        ...
        'GauntletEntrySpark': {'display': 'Gauntlet Entry Spark',
                               ...
                               'rooms': [('Landing Site', 'https://wiki.supermetroid.run/Landing_Site'), ('Gauntlet Entrance', 'https://wiki.supermetroid.run/Gauntlet_Entrance')]},
        'NorfairReserveIce': {'display': 'Norfair Reserve Ice',
                              'title': 'Climb to Norfair Reserve area by freezing a Waver',
                              'href': None,
                              'rooms': [('Bubble Mountain', 'https://wiki.supermetroid.run/Bubble_Mountain')]},
        'WaveBeamWallJump': {'display': 'Wave-Beam Wall-Jump',
                             ...
                             'rooms': [('Double Chamber', 'https://wiki.supermetroid.run/Double_Chamber')]},
        'ClimbToGrappleWithIce': {'display': 'Climb to Grapple With Ice',
                                  ...
                                  'href': None,
                                  'rooms': [('Post Crocomire Jump Room', 'https://wiki.supermetroid.run/Post_Crocomire_Jump_Room')]},
        'LavaDive': {'display': 'Lava Dive',
                     'title': 'Enter Lower Norfair with Varia and Hi-Jump',
                     'href': 'https://www.youtube.com/watch?v=pdyBy_54dB0',
                     'rooms': [('Lava Dive Room', 'https://wiki.supermetroid.run/Lava_Dive_Room')]},
        'WorstRoomIceCharge': {'display': 'Worst Room Ice and Charge',
                               ...
                               'rooms': [('The Worst Room In The Game', 'https://wiki.supermetroid.run/The_Worst_Room_In_The_Game')]},
        'ScrewAttackExit': {'display': 'Screw Attack Exit',
                            ...
                            'href': None,
                            'rooms': [('Screw Attack Room', 'https://wiki.supermetroid.run/Screw_Attack_Room'), ('Golden Torizo Energy Recharge', 'https://wiki.supermetroid.run/Golden_Torizo_Energy_Recharge')]},
        'ContinuousWallJump': {'display': 'Continuous Wall-Jump',
                               ...
                               'rooms': [('The Moat', 'https://wiki.supermetroid.run/The_Moat')]},
        ...
        'SpongeBathBombJump': {'display': 'SpongeBath Bomb-Jump',
                               ...
                               'rooms': [('Sponge Bath', 'https://wiki.supermetroid.run/Sponge_Bath')]},
        'SpongeBathHiJump': {'display': 'SpongeBath Hi-Jump',
                             'title': 'Get through sponge bath room (before spiky room of death) with Hi-Jump and Wall-Jumps',
                             'href': 'https://www.youtube.com/watch?v=8ldQUIgBavw',
                             'rooms': [('Sponge Bath', 'https://wiki.supermetroid.run/Sponge_Bath')]},
        'SpongeBathSpeed': {'display': 'SpongeBath Speed',
                            'title': 'Get through sponge bath room (before spiky room of death) with Speed Boster and Wall-Jumps',
                            'href': 'https://www.youtube.com/watch?v=8ldQUIgBavw',
                            'rooms': [('Sponge Bath', 'https://wiki.supermetroid.run/Sponge_Bath')]},
        'SuitlessOuterMaridia': {'display': 'Suitless Outer Maridia',
                                 ...
                                 'rooms': [('Main Street', 'https://wiki.supermetroid.run/Main_Street'), ('Mt. Everest', 'https://wiki.supermetroid.run/Mt._Everest'), ('Crab Shaft', 'https://wiki.supermetroid.run/Crab_Shaft'), ('Aqueduct', 'https://wiki.supermetroid.run/Aqueduct'), ('Botwoon Hallway', 'https://wiki.supermetroid.run/Botwoon_Hallway')]},
        'SuitlessOuterMaridiaNoGuns': {'display': 'Suitless Outer Maridia with no Guns',
                                       ...
                                       'href': 'https://www.youtube.com/watch?v=c2xoPigezvM',
                                       'rooms': [('Main Street', 'https://wiki.supermetroid.run/Main_Street')]},
        'MamaGrappleWithWallJump': {'display': 'Mama Grapple with Wall-Jump',
                                    ...
                                    'href': None,
                                    'rooms': [('Mama Turtle Room', 'https://wiki.supermetroid.run/Mama_Turtle_Room')]},
        ...
        'PreciousRoomXRayExit': {'display': 'Exit the Precious room with an Xray glitch',
                                 ...
                                 'rooms': [('The Precious Room', 'https://wiki.supermetroid.run/The_Precious_Room')]},
        'MochtroidClip': {'display': 'Mochtroid Clip',
                          ...
                          'rooms': [('Botwoon Hallway', 'https://wiki.supermetroid.run/Botwoon_Hallway')]},
        'PuyoClip': {'display': 'Puyo Clip',
                     ...
                     'rooms': [('Pants Room', 'https://wiki.supermetroid.run/Pants_Room')]},
        'KillPlasmaPiratesWithSpark': {'display': 'Kill Plasma Pirates with Spark',
                                       ...
                                       'href': None,
                                       'rooms': [('Plasma Room', 'https://wiki.supermetroid.run/Plasma_Room')]},
        ...
        'SuitlessSandpit': {'display': 'Suitless Sandpit',
                            ...
                            'rooms': [('West Sand Hole', 'https://wiki.supermetroid.run/West_Sand_Hole'), ('East Sand Hole', 'https://wiki.supermetroid.run/East_Sand_Hole')]}
}
