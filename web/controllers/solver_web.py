...
customSprites = {
    ...
    'hitbox_helper': {"index":4, "name": "Hitbox", "desc": "Samus, with her actual hitbox on top", "author": "Artheau and Komaru", "group": "Samus"},
    'hack_ancient_chozo': {"index":5, "name": "Chozo", "desc": "Samus, from Ancient Chozo hack", "author": "Physix", "group": "Samus"},
    ...
    'bailey': {"index":14, "name": "Bailey", "desc": "Justin Bailey, aka Samus in an 80s swimsuit", "author": "Auximines", "group": "Custom"},
    'alucard': {"index":15, "name": "Alucard", "desc": "Alucard from Castlevania Symphony Of The Night", "author": "Nintoaster", "group": "Custom"},
    'megaman': {"index":16, "name": "Megaman", "desc": "Megaman X!", "author": "Artheau", "group": "Custom"},
    'link': {"index":17, "name": "Link", "desc": "Sorry Link, your game is in another randomizer!", "author": "RonnSama", "group": "Custom"},
    'fed_trooper': {"index":18, "name": "GF Trooper", "desc": "A Galactic Federation trooper", "author": "Physix", "group": "Custom"},
    'super_controid': {"index":19, "name": "Contra", "desc": "Badass soldier from Contra III", "author": "Nintoaster", "group": "Custom"},
    'mario_8bit': {"index":20, "name": "Mario (NES)", "desc": "One of the bros", "author": "TarThoron", "group": "Custom"},
    'mario_8bit_modern': {"index":21, "name": "Mario (Alt)", "desc": "One of the bros, with a more modern palette", "author": "TarThoron", "group": "Custom"},
    'luigi': {"index":22, "name": "Luigi", "desc": "The other bro", "author": "RonnSama", "group": "Custom"},
    'marga': {"index":23, "name": "Margatroid", "desc": "Alice Margatroid from the Touhou Project", "author": "Plan", "group": "Custom"},
    'win95_cursor': {"index":24, "name": "Win95 Cursor", "desc": "A classic Windows cursor...", "author": "PlaguedOne", "group": "Custom"}
}
