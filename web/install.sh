...
[ -L ~/web2py/applications/solver/static/images/spongebath_blue_door.png ] || ln -s ~/RandomMetroidSolver/web/static/help/spongebath_blue_door.png ~/web2py/applications/solver/static/images/spongebath_blue_door.png
