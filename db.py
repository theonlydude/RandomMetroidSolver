...
order by r.id;"""
        ...
        paramsHead = []
        for param in ['seed', 'complexity', 'preset', 'area', 'majorsSplit', 'progressionSpeed', 'maxDifficulty', 'morphPlacement', 'suitsRestriction', 'energyQty', 'minorQty', 'missileQty', 'superQty', 'powerBombQty', 'progressionDifficulty']:
