...
where md5sum = '%s'
  and now() > date_add(create_time, interval interval_hours hour);"""
    ...
    def addExtStat(self, version, parameters, locsItems):
        if self.dbAvailable == False:
            return None
        ...
        try:
            self.cursor.execute(sql % (version, parameters['preset'], parameters['area'], parameters['boss'], parameters['majorsSplit'], parameters['progSpeed'], parameters['morphPlacement'], parameters['suitsRestriction'], parameters['progDiff'], parameters['superFunMovement'], parameters['superFunCombat'], parameters['superFunSuit']))
    ...
    def getExtStat(self, version, parameters):
...
where e.version = %d and e.preset = '%s' and e.area = %s and e.boss = %s and e.majorsSplit = '%s' and e.progSpeed = '%s' and e.morphPlacement = '%s' and e.suitsRestriction = %s and e.progDiff = '%s' and e.superFunMovement = %s and e.superFunCombat = %s and e.superFunSuit = %s;"""
        return self.execSelect(sql, (version, parameters['preset'], parameters['area'], parameters['boss'], parameters['majorsSplit'], parameters['progSpeed'], parameters['morphPlacement'], parameters['suitsRestriction'], parameters['progDiff'], parameters['superFunMovement'], parameters['superFunCombat'], parameters['superFunSuit']))
