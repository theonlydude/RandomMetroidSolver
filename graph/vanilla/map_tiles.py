...
objectives = {
    ...
    "CacatacsNoobBridge": {"area": "Brinstar", "map_coords_px": (30*8, 14*8), "event": getEnemiesRoomEvent("Cacatacs", "Noob Bridge")},
    ...
    "SpacePiratesPlasma": {"area": "Maridia", "map_coords_px": (28*8, 2*8), "event": getEnemiesRoomEvent("Space Pirates", "Plasma Room")},
