...
org map_data_Norfair+$370  ; (24, 13)
     dw $d825  ; BGtile[i=$25 p=$6 HVX]

org map_data_Norfair+$330  ; (24, 12)
     dw $d85a  ; BGtile[i=$5a p=$6 HVX]

org map_data_Norfair+$2f0  ; (24, 11)
     dw $1862  ; BGtile[i=$62 p=$6 X]

org map_data_Norfair+$36e  ; (23, 13)
     dw $9825  ; BGtile[i=$25 p=$6 VX]

org map_data_Norfair+$32e  ; (23, 12)
     dw $1872  ; BGtile[i=$72 p=$6 X]

org map_data_Norfair+$2ee  ; (23, 11)
     dw $1874  ; BGtile[i=$74 p=$6 X]

org map_data_Norfair+$2ec  ; (22, 11)
     dw $181d  ; BGtile[i=$1d p=$6 X]

;;; tiles for room "[Elevator to Lower Norfair]"

org map_data_Norfair+$2ea  ; (21, 11)
     dw $184f  ; BGtile[i=$4f p=$6 X]

;;; tiles for room "[Elevator Save Room]"

org map_data_Norfair+$2e8  ; (20, 11)
     dw $18b5  ; BGtile[i=$b5 p=$6 X]

;;; tiles for room "Acid Statue Room"

org map_data_Norfair+$39e  ; (15, 14)
     dw $1825  ; BGtile[i=$25 p=$6 X]

org map_data_Norfair+$3a0  ; (16, 14)
     dw $5829  ; BGtile[i=$29 p=$6 HX]

org map_data_Norfair+$3e0  ; (16, 15)
     dw $d825  ; BGtile[i=$25 p=$6 HVX]

org map_data_Norfair+$3de  ; (15, 15)
     dw $9825  ; BGtile[i=$25 p=$6 VX]

org map_data_Norfair+$41e  ; (15, 16)
     dw $9857  ; BGtile[i=$57 p=$6 VX]

org map_data_Norfair+$420  ; (16, 16)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$422  ; (17, 16)
     dw $581d  ; BGtile[i=$1d p=$6 HX]

;;; tiles for room "Main Hall"

org map_data_Norfair+$3a2  ; (17, 14)
     dw $181d  ; BGtile[i=$1d p=$6 X]

org map_data_Norfair+$3a4  ; (18, 14)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$3a6  ; (19, 14)
     dw $1852  ; BGtile[i=$52 p=$6 X]
...
org map_data_Norfair+$3ac  ; (22, 14)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$3ae  ; (23, 14)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$3b0  ; (24, 14)
     dw $581d  ; BGtile[i=$1d p=$6 HX]

;;; tiles for room "Golden Torizo's Room"

org map_data_Norfair+$424  ; (18, 16)
     dw $5804  ; BGtile[i=$04 p=$6 HX]

org map_data_Norfair+$426  ; (19, 16)
     dw $5826  ; BGtile[i=$26 p=$6 HX]

org map_data_Norfair+$466  ; (19, 17)
     dw $d829  ; BGtile[i=$29 p=$6 HVX]

org map_data_Norfair+$464  ; (18, 17)
     dw $9825  ; BGtile[i=$25 p=$6 VX]

;;; tiles for room "Fast Ripper Room"

org map_data_Norfair+$3ea  ; (21, 15)
     dw $181d  ; BGtile[i=$1d p=$6 X]

org map_data_Norfair+$3ec  ; (22, 15)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$3ee  ; (23, 15)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$3f0  ; (24, 15)
     dw $581d  ; BGtile[i=$1d p=$6 HX]

;;; tiles for room "[Screw Attack Energy Charge Room]"

org map_data_Norfair+$42a  ; (21, 16)
     dw $18c7  ; BGtile[i=$c7 p=$6 X]

;;; tiles for room "Ridley's Room"

org map_data_Norfair+$46e  ; (23, 17)
     dw $5890  ; BGtile[i=$90 p=$6 HX]

org map_data_Norfair+$4ae  ; (23, 18)
     dw $9890  ; BGtile[i=$90 p=$6 VX]

;;; tiles for room "Lower Norfair Farming Room"

org map_data_Norfair+$470  ; (24, 17)
     dw $181d  ; BGtile[i=$1d p=$6 X]

org map_data_Norfair+$472  ; (25, 17)
     dw $1852  ; BGtile[i=$52 p=$6 X]

org map_data_Norfair+$474  ; (26, 17)
     dw $581d  ; BGtile[i=$1d p=$6 HX]

;;; tiles for room "Fast Pillars Setup Room"

org map_data_Norfair+$372  ; (25, 13)
     dw $5890  ; BGtile[i=$90 p=$6 HX]
...
org map_data_Norfair+$476  ; (27, 17)
     dw $181d  ; BGtile[i=$1d p=$6 X]

org map_data_Norfair+$478  ; (28, 17)
     dw $1852  ; BGtile[i=$52 p=$6 X]
...
org map_data_Norfair+$a84  ; (34, 10)
     dw $5829  ; BGtile[i=$29 p=$6 HX]
...
org map_data_Norfair+$b04  ; (34, 12)
     dw $5872  ; BGtile[i=$72 p=$6 HX]
...
org map_data_Norfair+$b82  ; (33, 14)
     dw $9862  ; BGtile[i=$62 p=$6 VX]

org map_data_Norfair+$b84  ; (34, 14)
     dw $d825  ; BGtile[i=$25 p=$6 HVX]
...
org map_data_Norfair+$a86  ; (35, 10)
     dw $184d  ; BGtile[i=$4d p=$6 X]

org map_data_Norfair+$ac6  ; (35, 11)
     dw $181a  ; BGtile[i=$1a p=$6 X]

org map_data_Norfair+$b06  ; (35, 12)
     dw $181a  ; BGtile[i=$1a p=$6 X]

org map_data_Norfair+$b46  ; (35, 13)
     dw $5819  ; BGtile[i=$19 p=$6 HX]

org map_data_Norfair+$b86  ; (35, 14)
     dw $980a  ; BGtile[i=$0a p=$6 VX]

org map_data_Norfair+$b88  ; (36, 14)
     dw $1852  ; BGtile[i=$52 p=$6 X]
...
org map_data_Norfair+$c02  ; (33, 16)
     dw $181a  ; BGtile[i=$1a p=$6 X]
...
org map_data_Norfair+$4ac  ; (22, 18)
     dw $1806  ; BGtile[i=$06 p=$6 X]

;;; tiles for room "Screw Attack Room"

org map_data_Norfair+$468  ; (20, 17)
     dw $9892  ; BGtile[i=$92 p=$6 VX]

org map_data_Norfair+$428  ; (20, 16)
     dw $d890  ; BGtile[i=$90 p=$6 HVX]

org map_data_Norfair+$3e8  ; (20, 15)
     dw $5890  ; BGtile[i=$90 p=$6 HX]
...
org map_data_Norfair+$b08  ; (36, 12)
     dw $9825  ; BGtile[i=$25 p=$6 VX]
