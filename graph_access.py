...
accessPoints = [
    ...
    AccessPoint('PhantoonRoomOut', 'WreckedShip', {
       ...
       dotOrientation = 's'),
    AccessPoint('PhantoonRoomIn', 'WreckedShipBoss', {},
       boss = True,
    ...
    AccessPoint('RidleyRoomOut', 'LowerNorfair', {
       ...
       dotOrientation = 'e'),
    AccessPoint('RidleyRoomIn', 'LowerNorfairBoss', {},
       boss = True,
    ...
    AccessPoint('KraidRoomOut', 'Kraid', {
       ...
       traverse=lambda sm: sm.canOpenRedDoors(),
       dotOrientation = 'e'),
    AccessPoint('KraidRoomIn', 'KraidBoss', {},
       boss = True,
    ...
    AccessPoint('DraygonRoomOut', 'Maridia', {
       ...
       traverse=lambda sm: sm.canOpenRedDoors(),
       dotOrientation = 'e'),
    AccessPoint('DraygonRoomIn', 'MaridiaBoss', {},
       boss = True,
