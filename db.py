...
where md5sum = '%s'
  and now() > date_add(create_time, interval interval_hours hour);"""
    ...
    def dumpExtStat(parameters, locsItems, sqlFile):
       sql = "insert into extended_stats (version, preset, area, boss, majorsSplit, progSpeed, morphPlacement, suitsRestriction, progDiff, superFunMovement, superFunCombat, superFunSuit, count) values (%d, '%s', %s, %s, '%s', '%s', '%s', %s, '%s', %s, %s, %s, 1) on duplicate key update count = count + 1;\n"
       ...
       for (location, item) in locsItems.items():
           ...
           sql = "insert into item_locs (ext_id, item, {}) values (last_insert_id(), '%s', 1) on duplicate key update {} = {} + 1;\n".format(location, location, location)

           sqlFile.write(sql % (item,))

    def addExtStat(self, parameters, locsItems):
        if self.dbAvailable == False:
            return None
        ...
        try:
            self.cursor.execute(sql % (randoAlgoVersion, parameters['preset'], parameters['area'], parameters['boss'], parameters['majorsSplit'], parameters['progSpeed'], parameters['morphPlacement'], parameters['suitsRestriction'], parameters['progDiff'], parameters['superFunMovement'], parameters['superFunCombat'], parameters['superFunSuit']))
            id = self.cursor.lastrowid
        except Exception as e:
            print("DB.addExtStat::error execute: {} error: {}".format(sql, e))
            self.dbAvailable = False
            return
        ...
        for (location, item) in locsItems.items():
            ...
            # we can't have special chars in columns names
            location = location.translate(None, " ,()-")
            sql = """insert into item_locs (ext_id, item, {}) values (%d, '%s', 1) on duplicate key update {} = {} + 1;""".format(location, location, location)
    ...
    def getExtStat(self, parameters):
        sql = """select e.count, i.item, round(100*i.EnergyTankGauntlet/e.count, 1), round(100*i.Bomb/e.count, 1), round(100*i.EnergyTankTerminator/e.count, 1), round(100*i.ReserveTankBrinstar/e.count, 1), round(100*i.ChargeBeam/e.count, 1), round(100*i.MorphingBall/e.count, 1), round(100*i.EnergyTankBrinstarCeiling/e.count, 1), round(100*i.EnergyTankEtecoons/e.count, 1), round(100*i.EnergyTankWaterway/e.count, 1), round(100*i.EnergyTankBrinstarGate/e.count, 1), round(100*i.XRayScope/e.count, 1), round(100*i.Spazer/e.count, 1), round(100*i.EnergyTankKraid/e.count, 1), round(100*i.Kraid/e.count, 1), round(100*i.VariaSuit/e.count, 1), round(100*i.IceBeam/e.count, 1), round(100*i.EnergyTankCrocomire/e.count, 1), round(100*i.HiJumpBoots/e.count, 1), round(100*i.GrappleBeam/e.count, 1), round(100*i.ReserveTankNorfair/e.count, 1), round(100*i.SpeedBooster/e.count, 1), round(100*i.WaveBeam/e.count, 1), round(100*i.Ridley/e.count, 1), round(100*i.EnergyTankRidley/e.count, 1), round(100*i.ScrewAttack/e.count, 1), round(100*i.EnergyTankFirefleas/e.count, 1), round(100*i.ReserveTankWreckedShip/e.count, 1), round(100*i.EnergyTankWreckedShip/e.count, 1), round(100*i.Phantoon/e.count, 1), round(100*i.RightSuperWreckedShip/e.count, 1), round(100*i.GravitySuit/e.count, 1), round(100*i.EnergyTankMamaturtle/e.count, 1), round(100*i.PlasmaBeam/e.count, 1), round(100*i.ReserveTankMaridia/e.count, 1), round(100*i.SpringBall/e.count, 1), round(100*i.EnergyTankBotwoon/e.count, 1), round(100*i.Draygon/e.count, 1), round(100*i.SpaceJump/e.count, 1), round(100*i.MotherBrain/e.count, 1), round(100*i.PowerBombCrateriasurface/e.count, 1), round(100*i.MissileoutsideWreckedShipbottom/e.count, 1), round(100*i.MissileoutsideWreckedShiptop/e.count, 1), round(100*i.MissileoutsideWreckedShipmiddle/e.count, 1), round(100*i.MissileCrateriamoat/e.count, 1), round(100*i.MissileCrateriabottom/e.count, 1), round(100*i.MissileCrateriagauntletright/e.count, 1), round(100*i.MissileCrateriagauntletleft/e.count, 1), round(100*i.SuperMissileCrateria/e.count, 1), round(100*i.MissileCrateriamiddle/e.count, 1), round(100*i.PowerBombgreenBrinstarbottom/e.count, 1), round(100*i.SuperMissilepinkBrinstar/e.count, 1), round(100*i.MissilegreenBrinstarbelowsupermissile/e.count, 1), round(100*i.SuperMissilegreenBrinstartop/e.count, 1), round(100*i.MissilegreenBrinstarbehindmissile/e.count, 1), round(100*i.MissilegreenBrinstarbehindreservetank/e.count, 1), round(100*i.MissilepinkBrinstartop/e.count, 1), round(100*i.MissilepinkBrinstarbottom/e.count, 1), round(100*i.PowerBombpinkBrinstar/e.count, 1), round(100*i.MissilegreenBrinstarpipe/e.count, 1), round(100*i.PowerBombblueBrinstar/e.count, 1), round(100*i.MissileblueBrinstarmiddle/e.count, 1), round(100*i.SuperMissilegreenBrinstarbottom/e.count, 1), round(100*i.MissileblueBrinstarbottom/e.count, 1), round(100*i.MissileblueBrinstartop/e.count, 1), round(100*i.MissileblueBrinstarbehindmissile/e.count, 1), round(100*i.PowerBombredBrinstarsidehopperroom/e.count, 1), round(100*i.PowerBombredBrinstarspikeroom/e.count, 1), round(100*i.MissileredBrinstarspikeroom/e.count, 1), round(100*i.MissileKraid/e.count, 1), round(100*i.Missilelavaroom/e.count, 1), round(100*i.MissilebelowIceBeam/e.count, 1), round(100*i.MissileaboveCrocomire/e.count, 1), round(100*i.MissileHiJumpBoots/e.count, 1), round(100*i.EnergyTankHiJumpBoots/e.count, 1), round(100*i.PowerBombCrocomire/e.count, 1), round(100*i.MissilebelowCrocomire/e.count, 1), round(100*i.MissileGrappleBeam/e.count, 1), round(100*i.MissileNorfairReserveTank/e.count, 1), round(100*i.MissilebubbleNorfairgreendoor/e.count, 1), round(100*i.MissilebubbleNorfair/e.count, 1), round(100*i.MissileSpeedBooster/e.count, 1), round(100*i.MissileWaveBeam/e.count, 1), round(100*i.MissileGoldTorizo/e.count, 1), round(100*i.SuperMissileGoldTorizo/e.count, 1), round(100*i.MissileMickeyMouseroom/e.count, 1), round(100*i.MissilelowerNorfairabovefireflearoom/e.count, 1), round(100*i.PowerBomblowerNorfairabovefireflearoom/e.count, 1), round(100*i.PowerBombPowerBombsofshame/e.count, 1), round(100*i.MissilelowerNorfairnearWaveBeam/e.count, 1), round(100*i.MissileWreckedShipmiddle/e.count, 1), round(100*i.MissileGravitySuit/e.count, 1), round(100*i.MissileWreckedShiptop/e.count, 1), round(100*i.SuperMissileWreckedShipleft/e.count, 1), round(100*i.MissilegreenMaridiashinespark/e.count, 1), round(100*i.SuperMissilegreenMaridia/e.count, 1), round(100*i.MissilegreenMaridiatatori/e.count, 1), round(100*i.SuperMissileyellowMaridia/e.count, 1), round(100*i.MissileyellowMaridiasupermissile/e.count, 1), round(100*i.MissileyellowMaridiafalsewall/e.count, 1), round(100*i.MissileleftMaridiasandpitroom/e.count, 1), round(100*i.MissilerightMaridiasandpitroom/e.count, 1), round(100*i.PowerBombrightMaridiasandpitroom/e.count, 1), round(100*i.MissilepinkMaridia/e.count, 1), round(100*i.SuperMissilepinkMaridia/e.count, 1), round(100*i.MissileDraygon/e.count, 1)
from extended_stats e join item_locs i on e.id = i.ext_id
where e.version = %d and e.preset = '%s' and e.area = %s and e.boss = %s and e.majorsSplit = '%s' and e.progSpeed = '%s' and e.morphPlacement = '%s' and e.suitsRestriction = %s and e.progDiff = '%s' and e.superFunMovement = %s and e.superFunCombat = %s and e.superFunSuit = %s;"""
        return self.execSelect(sql, (randoAlgoVersion, parameters['preset'], parameters['area'], parameters['boss'], parameters['majorsSplit'], parameters['progSpeed'], parameters['morphPlacement'], parameters['suitsRestriction'], parameters['progDiff'], parameters['superFunMovement'], parameters['superFunCombat'], parameters['superFunSuit']))
