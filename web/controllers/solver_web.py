...
customSprites = {
    ...
    'hack_phazon': {"index":13, "name": "Phazon", "desc": "Samus, from Phazon hack", "author": "A_red_monk_called_Key", "group": "Samus"},
    'hack_redesign': {"index":14, "name": "Redesign", "desc": "Samus, from Redesign hack", "author": "Drewseph", "group": "Samus"},
    'hack_szm': {"index":15, "name": "SZM", "desc": "Samus, from Super Zero Mission hack", "author": "SBniconico", "group": "Samus"},
    'hitbox_helper': {"index":16, "name": "Hitbox", "desc": "Samus, with her actual hitbox on top", "author": "Artheau and Komaru", "group": "Samus"},
    'bailey': {"index":17, "name": "Bailey", "desc": "Justin Bailey, aka Samus in an 80s swimsuit", "author": "Auximines", "group": "Custom"},
    'alucard': {"index":18, "name": "Alucard", "desc": "Alucard from Castlevania Symphony Of The Night", "author": "Nintoaster", "group": "Custom"},
    'megaman': {"index":19, "name": "Megaman", "desc": "Megaman X!", "author": "Artheau", "group": "Custom"},
    'link': {"index":20, "name": "Link", "desc": "Sorry Link, your game is in another randomizer!", "author": "RonnSama", "group": "Custom"},
    'fed_trooper': {"index":21, "name": "GF Trooper", "desc": "A Galactic Federation trooper", "author": "Physix", "group": "Custom"},
    'super_controid': {"index":22, "name": "Contra", "desc": "Badass soldier from Contra III", "author": "Nintoaster", "group": "Custom"},
    'mario_8bit': {"index":23, "name": "Mario (NES)", "desc": "One of the bros", "author": "TarThoron", "group": "Custom"},
    'mario_8bit_modern': {"index":24, "name": "Mario (Alt)", "desc": "One of the bros, with a more modern palette", "author": "TarThoron", "group": "Custom"},
    'luigi': {"index":25, "name": "Luigi", "desc": "The other bro", "author": "RonnSama", "group": "Custom"},
    'marga': {"index":26, "name": "Margatroid", "desc": "Alice Margatroid from the Touhou Project", "author": "Plan", "group": "Custom"},
    'sprite_can': {"index":27, "name": "Sprite", "desc": "A ... Sprite ... ", "author": "TarThoron", "group": "Custom"},
    'win95_cursor': {"index":28, "name": "Win95 Cursor", "desc": "A classic Windows cursor...", "author": "PlaguedOne", "group": "Custom"}
}
