patches = {
    ...
    "Save_Mama": {
        # load point entry
        0x496B: [0x55, 0xD0, 0xE4, 0xA3, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x38, 0x00, 0xE0, 0xFF],
        # music in room state header
        0x7d066: [0x1b, 0x06],
        # map icon X/Y
        0x14a0b: [0x97, 0x00, 0x6f, 0x00]
    },
    # TODO
    "Save_Aqueduct": {
        # load point entry
