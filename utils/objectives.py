...
_goalsList = [
    ...
    Goal("explore croc's lair", "map", lambda sm, ap: sm.wand(Objectives.canExploreArea(sm, ap, "Crocomire"),
         ...
         category="Map",
         area="Crocomire"),
    Goal("explore lower norfair", "map", lambda sm, ap: sm.wand(Objectives.canExploreArea(sm, ap, "LowerNorfair"), sm.canExploreAmphitheater()),
    ...
    Goal("explore west maridia", "map", lambda sm, ap: sm.wand(Objectives.canExploreArea(sm, ap, "WestMaridia"), sm.canGoUpMtEverest()),
         ...
         category="Map",
         area="WestMaridia"),
    Goal("explore east maridia", "map", lambda sm, ap: sm.wand(Objectives.canExploreArea(sm, ap, "EastMaridia"), sm.canPassCacatacAlley()),
