...
doors_mapicons_sprite_table:
	dw red_Left,green_Left,yellow_Left,grey_Left,wave_Left,plasma_Left,spazer_Left,ice_Left,red_Bottom,green_Bottom,yellow_Bottom,grey_Bottom,wave_Bottom,plasma_Bottom,spazer_Bottom,ice_Bottom,red_Right,green_Right,yellow_Right,grey_Right,wave_Right,plasma_Right,spazer_Right,ice_Right,red_Top,green_Top,yellow_Top,grey_Top,wave_Top,plasma_Top,spazer_Top,ice_Top
