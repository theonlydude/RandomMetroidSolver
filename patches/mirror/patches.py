...
additional_PLMs = {
    ...
    'WS_Map_Grey_Door': {
        'room': 0xcc6f,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x4e, 0x5, 0x61, 0x90],
        ],
    },
    'WS_Map_Grey_Door_Openable': {
        'room': 0xcc6f,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x4e, 0x5, 0x61, 0x10],
        ],
    },
    'WS_Save_Blinking_Door': {
        ...
        'state': 0xcb08,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x11, 0x35, 0x62, 0xc],
        ],
    },
    'Maridia Sand Hall Seal': {
        'room': 0xd252,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x1, 0x5, 0x63, 0x90],
        ],
    },
    'Save_G4': {
        'room': 0xa5ed,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x12, 0xb, 0x7, 0x0],
        ],
    },
    'Save_Gauntlet': {
        'room': 0x99bd,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x3, 0x9, 0x6, 0x0],
        ],
    },
    'Save_Watering_Hole': {
        'room': 0xd13b,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0xb, 0x9, 0x7, 0x0],
        ],
    },
    'Save_Mama': {
        'room': 0xd055,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x9, 0xa, 0x6, 0x0],
        ],
    },
    'Save_Aqueduct': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x6, 0x8, 0x5, 0x0],
        ],
    },
    'Save_Etecoons': {
        'room': 0xa051,
    ...
    'Save_Firefleas': {
        'room': 0xb55a,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x8, 0x8, 0x7, 0x0],
        ],
    },
    'Save_Crab_Shaft': {
        'room': 0xd1a3,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x12, 0x28, 0x9, 0x0],
        ],
    },
    'Save_Main_Street': {
        'room': 0xcfc9,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x17, 0x58, 0xa, 0x0],
        ],
    },
    'Blinking[Moat Right]': {
        'room': 0x95ff,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x1, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Lower Mushrooms Left]': {
        'room': 0x9969,
    ...
    'Blinking[Warehouse Zeela Room Left]': {
        'room': 0xa471,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x1e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Warehouse Entrance Right]': {
        'room': 0xa6a1,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x2e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Warehouse Entrance Left]': {
        'room': 0xa6a1,
    ...
    'Blinking[West Ocean Left]': {
        'room': 0x93fe,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x7e, 0x45, 0x63, 0x8c],
        ],
    },
    'Blinking[Crab Maze Left]': {
        'room': 0x957d,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x3e, 0x15, 0x63, 0x8c],
        ],
    },
    'Blinking[Crab Hole Bottom Left]': {
        'room': 0xd21c,
        'plm_bytes_list': [
            [0x42, 0xc8, 0xe, 0x15, 0x63, 0x8c],
        ],
    },
    'Blinking[Main Street Bottom]': {
        'room': 0xcfc9,
        'plm_bytes_list': [
            [0x4e, 0xc8, 0x19, 0x7c, 0x63, 0x8c],
        ],
    },
    'Blinking[Red Fish Room Left]': {
        'room': 0xd104,
    ...
    'Blinking[East Tunnel Right]': {
        'room': 0xcf80,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x31, 0x15, 0x63, 0x8c],
        ],
    },
    'Blinking[Glass Tunnel Top]': {
        'room': 0xcefb,
        'plm_bytes_list': [
            [0x54, 0xc8, 0x9, 0x1, 0x63, 0x8c],
        ],
    },
    'Blinking[Red Tower Top Left]': {
        'room': 0xa253,
        'plm_bytes_list': [
            [0x42, 0xc8, 0xe, 0x45, 0x63, 0x8c],
        ],
    },
    'Blinking[Caterpillar Room Top Right]': {
        'room': 0xa322,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x1, 0x35, 0x63, 0x8c],
        ],
    },
    'Blinking[Below Botwoon Energy Tank Right]': {
        'room': 0xd6fd,
    ...
    'Blinking[Aqueduct Top Left]': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x5e, 0x15, 0x63, 0x8c],
        ],
    },
    'Indicator[LandingSiteRight]': {
        'room': 0x948c,
        'plm_bytes_list': [
            [0xff, 0xff, 0x2e, 0x5, 0x0, 0x0],
        ],
    },
    'Indicator[KihunterRight]': {
        'room': 0x95ff,
        'plm_bytes_list': [
            [0xff, 0xff, 0x1e, 0x5, 0xd, 0x0],
        ],
    },
    'Indicator[NoobBridgeRight]': {
        'room': 0xa253,
        'plm_bytes_list': [
            [0xff, 0xff, 0xe, 0x45, 0x33, 0x0],
        ],
    },
    'Indicator[MainShaftBottomRight]': {
        'room': 0x9cb3,
        'plm_bytes_list': [
            [0xff, 0xff, 0x6e, 0x5, 0x22, 0x0],
        ],
    },
    'Indicator[BigPinkBottomRight]': {
        'room': 0x9e52,
        'plm_bytes_list': [
            [0xff, 0xff, 0x7e, 0x5, 0x29, 0x0],
        ],
    },
    'Indicator[RedTowerElevatorLeft]': {
        'room': 0xa2f7,
        'plm_bytes_list': [
            [0xff, 0xff, 0x1, 0x5, 0x3c, 0x0],
        ],
    },
    'Indicator[WestOceanRight]': {
        'room': 0xca08,
        'plm_bytes_list': [
            [0xff, 0xff, 0x3e, 0x5, 0xc, 0x0],
        ],
    },
    'Indicator[LeCoudeBottom]': {
        'room': 0x94cc,
        'plm_bytes_list': [
            [0xff, 0xff, 0x9, 0x1, 0xf, 0x0],
        ],
    },
    'Indicator[WreckedShipMainShaftBottom]': {
        'room': 0xcc6f,
        'plm_bytes_list': [
            [0xff, 0xff, 0x29, 0x1, 0x84, 0x0],
        ],
    },
    'Indicator[CathedralEntranceRight]': {
        'room': 0xa788,
        'plm_bytes_list': [
            [0xff, 0xff, 0x2e, 0x5, 0x4a, 0x0],
        ],
    },
    'Indicator[CathedralRight]': {
        'room': 0xafa3,
        'plm_bytes_list': [
            [0xff, 0xff, 0x4e, 0x5, 0x49, 0x0],
        ],
    },
    'Indicator[RedKihunterShaftBottom]': {
        'room': 0xb5d5,
        'plm_bytes_list': [
            [0xff, 0xff, 0x9, 0x1, 0x5e, 0x0],
        ],
    },
    'Indicator[WastelandLeft]': {
        'room': 0xb62b,
        'plm_bytes_list': [
            [0xff, 0xff, 0x1, 0x5, 0x5f, 0x0],
        ],
    },
    'Indicator[MainStreetBottomRight]': {
        'room': 0xd08a,
        'plm_bytes_list': [
            [0xff, 0xff, 0x3e, 0x5, 0x8d, 0x0],
        ],
    },
    'Indicator[CrabShaftRight]': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0xff, 0xff, 0x5e, 0x15, 0x8f, 0x0],
        ],
    },
    'Indicator[ColosseumBottomRight]': {
        'room': 0xd78f,
        'plm_bytes_list': [
            [0xff, 0xff, 0x1e, 0x5, 0x9a, 0x0],
        ],
    },
}
