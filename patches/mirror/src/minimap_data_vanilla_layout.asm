...
;;; ['West Ocean', 'The Moat', 'Crateria Keyhunter Room', '[Elevator to Red Brinstar]', 'Crateria Power Bomb Room', 'Crateria Tube', 'Landing Site', 'Bomb Torizo Room', 'Flyway', 'Crateria Super Room', 'Crateria Map Room', '[Elevator to Blue Brinstar]', 'Gauntlet Entrance', 'Parlor and Alcatraz', 'Pre-Map Flyway', 'Pit Room [Old Mother Brain Room]', 'Climb', '[Parlor Save Room]', 'Final Missile Bombway', 'Gauntlet Energy Tank Room', 'Terminator Room', 'Statues Room', 'The Final Missile', 'Statues Hallway', 'Green Pirates Shaft', 'Lower Mushrooms', '[Elevator to Green Brinstar]']
minimap_room_type_7:
	dw palette_triplet_1
	dw !AreaColor_Tourian
	dw !AreaColor_WreckedShip
