...
patches = {
    ...
    'Blinking[Green Hill Zone Top Right]': {
        ...
        snes_to_pc(0x8f8670): [0x42, 0xc8, 0x61, 0x6, 0x63, 0x8c],
        snes_to_pc(0xa19d5b): [0x0],
    },
    'Blinking[Noob Bridge Right]': {
        # door Door_33_Room_9FBA_PLM_ x/y updated
        snes_to_pc(0x8f87a6): [0x42, 0xc8, 0x1, 0x6, 0x63, 0x8c],
    ...
    'Blinking[KraidRoomOut]': {
        ...
        snes_to_pc(0x8f8a1a): [0x42, 0xc8, 0x1, 0x16, 0x63, 0x8c, 0x0, 0x0],
    ...
    'Blinking[Kronic Boost Room Bottom Left]': {
        ...
        snes_to_pc(0x8f8d4e): [0x48, 0xc8, 0xe, 0x26, 0x58, 0x8c],
    ...
    'Blinking[RidleyRoomOut]': {
        ...
        snes_to_pc(0x8f8ea6): [0x48, 0xc8, 0x2e, 0x6, 0x63, 0x8c, 0x0, 0x0],
    ...
    'Blinking[PhantoonRoomOut]': {
        ...
        snes_to_pc(0x8fc29d): [0x42, 0xc8, 0x1, 0x6, 0x63, 0x8c, 0x0, 0x0],
    ...
    'Blinking[Le Coude Right]': {
        ...
        snes_to_pc(0x8f823e): [0x42, 0xc8, 0x6, 0xd, 0x63, 0x8c],
        snes_to_pc(0xa185dd): [0x0],
    },
    'Blinking[DraygonRoomOut]': {
        # door Door_9B_Room_D78F_PLM_ x/y updated
        snes_to_pc(0x8fc73b): [0x48, 0xc8, 0x1e, 0x26, 0x63, 0x8c, 0x3b, 0xb6, 0x31, 0x26, 0x0, 0x0, 0x3b, 0xb6, 0x31, 0x26, 0x0, 0x0],
    ...
    'Blinking[Climb Bottom Left]': {
        ...
        snes_to_pc(0x8f82fe): [0x48, 0xc8, 0x2e, 0x86, 0x12, 0x8c],
...
additional_PLMs = {
    ...
    'WS_Map_Grey_Door': {
        'room': 0xcc6f,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x9e, 0x5, 0x61, 0x90],
        ],
    },
    'WS_Map_Grey_Door_Openable': {
        'room': 0xcc6f,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x9e, 0x5, 0x61, 0x10],
        ],
    },
    'WS_Save_Blinking_Door': {
        ...
        'state': 0xcb08,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x71, 0x35, 0x62, 0xc],
        ],
    },
    'Maridia Sand Hall Seal': {
        'room': 0xd252,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x11, 0x5, 0x63, 0x90],
        ],
    },
    'Save_G4': {
        'room': 0xa5ed,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x62, 0xb, 0x7, 0x0],
        ],
    },
    'Save_Gauntlet': {
        'room': 0x99bd,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x13, 0x9, 0x6, 0x0],
        ],
    },
    'Save_Watering_Hole': {
        'room': 0xd13b,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x2b, 0x9, 0x7, 0x0],
        ],
    },
    'Save_Mama': {
        'room': 0xd055,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x39, 0xa, 0x6, 0x0],
        ],
    },
    'Save_Aqueduct': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x66, 0x8, 0x5, 0x0],
        ],
    },
    'Save_Etecoons': {
        'room': 0xa051,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x1b, 0xa, 0x7, 0x0],
        ],
    },
    'Save_Firefleas': {
        'room': 0xb55a,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x18, 0x8, 0x7, 0x0],
        ],
    },
    'Save_Crab_Shaft': {
        'room': 0xd1a3,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x32, 0x28, 0x9, 0x0],
        ],
    },
    'Save_Main_Street': {
        'room': 0xcfc9,
        'plm_bytes_list': [
            [0x6f, 0xb7, 0x47, 0x58, 0xa, 0x0],
        ],
    },
    'Blinking[Moat Right]': {
        'room': 0x95ff,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x21, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Lower Mushrooms Left]': {
        'room': 0x9969,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x7e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Golden Four]': {
        'room': 0xa5ed,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x9e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Green Brinstar Elevator]': {
        'room': 0x9938,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x11, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Warehouse Zeela Room Left]': {
        'room': 0xa471,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x3e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Warehouse Entrance Right]': {
        'room': 0xa6a1,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x5e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Warehouse Entrance Left]': {
        'room': 0xa6a1,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x31, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Single Chamber Top Right]': {
        'room': 0xad5e,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x61, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Three Muskateers Room Left]': {
        'room': 0xb656,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x6e, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[Lava Dive Right]': {
        'room': 0xaf14,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x41, 0x5, 0x63, 0x8c],
        ],
    },
    'Blinking[West Ocean Left]': {
        'room': 0x93fe,
        'plm_bytes_list': [
            [0x42, 0xc8, 0xfe, 0x45, 0x63, 0x8c],
        ],
    },
    'Blinking[Crab Maze Left]': {
        'room': 0x957d,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x7e, 0x15, 0x63, 0x8c],
        ],
    },
    'Blinking[Crab Hole Bottom Left]': {
        'room': 0xd21c,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x1e, 0x15, 0x63, 0x8c],
        ],
    },
    'Blinking[Main Street Bottom]': {
        'room': 0xcfc9,
        'plm_bytes_list': [
            [0x4e, 0xc8, 0x49, 0x7c, 0x63, 0x8c],
        ],
    },
    'Blinking[Red Fish Room Left]': {
        'room': 0xd104,
    ...
    'Blinking[East Tunnel Right]': {
        'room': 0xcf80,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x71, 0x15, 0x63, 0x8c],
        ],
    },
    'Blinking[Glass Tunnel Top]': {
        'room': 0xcefb,
        'plm_bytes_list': [
            [0x54, 0xc8, 0x19, 0x1, 0x63, 0x8c],
        ],
    },
    'Blinking[Red Tower Top Left]': {
        'room': 0xa253,
        'plm_bytes_list': [
            [0x42, 0xc8, 0x1e, 0x45, 0x63, 0x8c],
        ],
    },
    'Blinking[Caterpillar Room Top Right]': {
        'room': 0xa322,
        'plm_bytes_list': [
            [0x48, 0xc8, 0x31, 0x35, 0x63, 0x8c],
        ],
    },
    'Blinking[Below Botwoon Energy Tank Right]': {
        'room': 0xd6fd,
    ...
    'Blinking[Aqueduct Top Left]': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0x42, 0xc8, 0xbe, 0x15, 0x63, 0x8c],
        ],
    },
    'Indicator[LandingSiteRight]': {
        'room': 0x948c,
        'plm_bytes_list': [
            [0xff, 0xff, 0x5e, 0x5, 0x0, 0x0],
        ],
    },
    'Indicator[KihunterRight]': {
        'room': 0x95ff,
        'plm_bytes_list': [
            [0xff, 0xff, 0x3e, 0x5, 0xd, 0x0],
        ],
    },
    'Indicator[NoobBridgeRight]': {
        'room': 0xa253,
        'plm_bytes_list': [
            [0xff, 0xff, 0x1e, 0x45, 0x33, 0x0],
        ],
    },
    'Indicator[MainShaftBottomRight]': {
        'room': 0x9cb3,
        'plm_bytes_list': [
            [0xff, 0xff, 0xde, 0x5, 0x22, 0x0],
        ],
    },
    'Indicator[BigPinkBottomRight]': {
        'room': 0x9e52,
        'plm_bytes_list': [
            [0xff, 0xff, 0xfe, 0x5, 0x29, 0x0],
        ],
    },
    'Indicator[RedTowerElevatorLeft]': {
        'room': 0xa2f7,
        'plm_bytes_list': [
            [0xff, 0xff, 0x31, 0x5, 0x3c, 0x0],
        ],
    },
    'Indicator[WestOceanRight]': {
        'room': 0xca08,
        'plm_bytes_list': [
            [0xff, 0xff, 0x7e, 0x5, 0xc, 0x0],
        ],
    },
    'Indicator[LeCoudeBottom]': {
        'room': 0x94cc,
        'plm_bytes_list': [
            [0xff, 0xff, 0x19, 0x1, 0xf, 0x0],
        ],
    },
    'Indicator[WreckedShipMainShaftBottom]': {
        'room': 0xcc6f,
        'plm_bytes_list': [
            [0xff, 0xff, 0x79, 0x1, 0x84, 0x0],
        ],
    },
    'Indicator[CathedralEntranceRight]': {
        'room': 0xa788,
        'plm_bytes_list': [
            [0xff, 0xff, 0x5e, 0x5, 0x4a, 0x0],
        ],
    },
    'Indicator[CathedralRight]': {
        'room': 0xafa3,
        'plm_bytes_list': [
            [0xff, 0xff, 0x9e, 0x5, 0x49, 0x0],
        ],
    },
    'Indicator[RedKihunterShaftBottom]': {
        'room': 0xb5d5,
        'plm_bytes_list': [
            [0xff, 0xff, 0x69, 0x1, 0x5e, 0x0],
        ],
    },
    'Indicator[WastelandLeft]': {
        'room': 0xb62b,
        'plm_bytes_list': [
            [0xff, 0xff, 0x31, 0x5, 0x5f, 0x0],
        ],
    },
    'Indicator[MainStreetBottomRight]': {
        'room': 0xd08a,
        'plm_bytes_list': [
            [0xff, 0xff, 0x7e, 0x5, 0x8d, 0x0],
        ],
    },
    'Indicator[CrabShaftRight]': {
        'room': 0xd5a7,
        'plm_bytes_list': [
            [0xff, 0xff, 0xbe, 0x15, 0x8f, 0x0],
        ],
    },
    'Indicator[ColosseumBottomRight]': {
        'room': 0xd78f,
        'plm_bytes_list': [
            [0xff, 0xff, 0x3e, 0x5, 0x9a, 0x0],
        ],
    },
}
