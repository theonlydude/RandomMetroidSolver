...
if enableMode7:
    ...
    def applyPercent(i, basePalette):
        # percents computed with vanilla palette using extract_ship_pal7.py
        percents = [
            [[0, 0, 0], [3.33, 6.9, 72.22], [24.0, 47.62, 3000.0], [210.0, 342.86, 31], [31, 31, 31], [19.23, 24.0, 520.0], [40.91, 63.16, 31], [72.22, 106.67, 31], [138.46, 210.0, 31], [31, 0.0, 121.43], [31, 55.0, 244.44], [31, 158.33, 520.0], [106.67, 106.67, 72.22], [244.44, 244.44, 158.33], [520.0, 520.0, 287.5], [31, 31, 31]],
            [[0, 0, 0], [-10.0, -6.9, 50.0], [8.0, 28.57, 2500.0], [160.0, 271.43, 26], [26, 26, 26], [3.85, 8.0, 420.0], [22.73, 42.11, 26], [50.0, 80.0, 26], [107.69, 160.0, 26], [26, -12.9, 92.86], [26, 35.0, 188.89], [26, 125.0, 420.0], [80.0, 80.0, 50.0], [188.89, 188.89, 125.0], [420.0, 420.0, 225.0], [27, 26, 26]],
            [[0, 0, 0], [-20.0, -17.24, 27.78], [-4.0, 9.52, 2100.0], [120.0, 214.29, 22], [22, 22, 22], [-7.69, -4.0, 340.0], [4.55, 21.05, 22], [27.78, 53.33, 22], [76.92, 120.0, 22], [22, -22.58, 64.29], [22, 15.0, 144.44], [22, 91.67, 340.0], [53.33, 53.33, 27.78], [144.44, 144.44, 91.67], [340.0, 340.0, 175.0], [23, 22, 22]],
            [[0, 0, 0], [-30.0, -27.59, 5.56], [-20.0, -4.76, 1600.0], [80.0, 157.14, 17], [17, 17, 17], [-23.08, -20.0, 260.0], [-9.09, 0.0, 17], [5.56, 26.67, 17], [46.15, 80.0, 17], [17, -32.26, 35.71], [17, -5.0, 100.0], [17, 58.33, 260.0], [26.67, 26.67, 5.56], [100.0, 100.0, 58.33], [260.0, 260.0, 125.0], [19, 17, 18]],
            [[0, 0, 0], [-43.33, -41.38, -11.11], [-32.0, -23.81, 1200.0], [40.0, 100.0, 13], [13, 13, 13], [-34.62, -32.0, 160.0], [-27.27, -15.79, 13], [-11.11, 0.0, 13], [15.38, 40.0, 13], [13, -45.16, 7.14], [13, -20.0, 55.56], [13, 25.0, 160.0], [0.0, 0.0, -11.11], [55.56, 55.56, 25.0], [160.0, 160.0, 75.0], [15, 13, 13]],
            [[0, 0, 0], [-53.33, -51.72, -33.33], [-48.0, -38.1, 700.0], [0.0, 42.86, 8], [8, 8, 8], [-50.0, -48.0, 80.0], [-40.91, -36.84, 8], [-33.33, -26.67, 8], [-15.38, 0.0, 8], [8, -54.84, -21.43], [8, -40.0, 11.11], [8, -8.33, 80.0], [-26.67, -26.67, -33.33], [11.11, 11.11, -8.33], [80.0, 80.0, 25.0], [11, 8, 9]],
            [[0, 0, 0], [-63.33, -62.07, -55.56], [-60.0, -57.14, 300.0], [-40.0, -14.29, 4], [4, 4, 4], [-61.54, -60.0, 0.0], [-59.09, -57.89, 4], [-55.56, -53.33, 4], [-46.15, -40.0, 4], [4, -64.52, -50.0], [4, -60.0, -33.33], [4, -41.67, 0.0], [-53.33, -53.33, -55.56], [-33.33, -33.33, -41.67], [0.0, 0.0, -25.0], [7, 4, 5]],
            [[0, 0, 0], [-73.33, -72.41, -72.22], [-72.0, -71.43, -100.0], [-80.0, -71.43, 0], [0, 0, 0], [-73.08, -72.0, -80.0], [-72.73, -73.68, 0], [-72.22, -73.33, 0], [-76.92, -80.0, 0], [0, -74.19, -71.43], [0, -75.0, -77.78], [0, -75.0, -80.0], [-73.33, -73.33, -72.22], [-77.78, -77.78, -75.0], [-80.0, -80.0, -75.0], [4, 0, 1]],
            [[0, 0, 0], [-73.33, -72.41, -72.22], [-72.0, -71.43, -100.0], [-80.0, -71.43, 0], [0, 0, 0], [-73.08, -72.0, -80.0], [-72.73, -73.68, 0], [-72.22, -73.33, 0], [-76.92, -80.0, 0], [0, -74.19, -71.43], [0, -75.0, -77.78], [0, -75.0, -80.0], [-73.33, -73.33, -72.22], [-77.78, -77.78, -75.0], [-80.0, -80.0, -75.0], [0, 0, 0]],
            [[0, 0, 0], [-63.33, -62.07, -61.11], [-60.0, -61.9, -100.0], [-70.0, -57.14, 0], [0, 0, 0], [-61.54, -60.0, -60.0], [-63.64, -63.16, 0], [-61.11, -60.0, 0], [-69.23, -70.0, 0], [0, -64.52, -64.29], [0, -65.0, -66.67], [0, -66.67, -60.0], [-60.0, -60.0, -61.11], [-66.67, -66.67, -66.67], [-60.0, -60.0, -62.5], [0, 0, 0]],
            [[0, 0, 0], [-53.33, -51.72, -50.0], [-52.0, -52.38, -100.0], [-60.0, -57.14, 0], [0, 0, 0], [-53.85, -52.0, -60.0], [-50.0, -52.63, 0], [-50.0, -53.33, 0], [-53.85, -60.0, 0], [0, -51.61, -50.0], [0, -55.0, -55.56], [0, -50.0, -60.0], [-53.33, -53.33, -50.0], [-55.56, -55.56, -50.0], [-60.0, -60.0, -50.0], [0, 0, 0]],
            [[0, 0, 0], [-43.33, -41.38, -38.89], [-40.0, -42.86, -100.0], [-50.0, -42.86, 0], [0, 0, 0], [-42.31, -40.0, -40.0], [-40.91, -42.11, 0], [-38.89, -40.0, 0], [-46.15, -50.0, 0], [0, -41.94, -42.86], [0, -45.0, -44.44], [0, -41.67, -40.0], [-40.0, -40.0, -38.89], [-44.44, -44.44, -41.67], [-40.0, -40.0, -37.5], [0, 0, 0]],
            [[0, 0, 0], [-30.0, -31.03, -33.33], [-32.0, -28.57, 0.0], [-30.0, -28.57, 0], [0, 0, 0], [-30.77, -32.0, -40.0], [-31.82, -31.58, 0], [-33.33, -33.33, 0], [-30.77, -30.0, 0], [0, -32.26, -28.57], [0, -30.0, -33.33], [0, -33.33, -40.0], [-33.33, -33.33, -33.33], [-33.33, -33.33, -33.33], [-40.0, -40.0, -37.5], [0, 0, 0]],
            [[0, 0, 0], [-20.0, -20.69, -22.22], [-20.0, -19.05, 0.0], [-20.0, -14.29, 0], [0, 0, 0], [-19.23, -20.0, -20.0], [-22.73, -21.05, 0], [-22.22, -20.0, 0], [-23.08, -20.0, 0], [0, -22.58, -21.43], [0, -20.0, -22.22], [0, -25.0, -20.0], [-20.0, -20.0, -22.22], [-22.22, -22.22, -25.0], [-20.0, -20.0, -25.0], [0, 0, 0]],
            [[0, 0, 0], [-10.0, -10.34, -11.11], [-12.0, -9.52, 0.0], [-10.0, -14.29, 0], [0, 0, 0], [-11.54, -12.0, -20.0], [-9.09, -10.53, 0], [-11.11, -13.33, 0], [-7.69, -10.0, 0], [0, -9.68, -7.14], [0, -10.0, -11.11], [0, -8.33, -20.0], [-13.33, -13.33, -11.11], [-11.11, -11.11, -8.33], [-20.0, -20.0, -12.5], [0, 0, 0]]
        ]
        percent = percents[i]
        computedPalette = []
        ...
        for perc, color in zip(percent, basePalette):
            color = extractColors(color)
            computedPalette.append(createColor(*[max(min(int(c + (c * p) / 100), 31), 0) if c > 0 else abs(int(p//8)) for p, c in zip(perc, color)]))
