...
locs_Crateria:
	dw $05,$07,$08,$1a,$1d,$00,$04,$06,$09,$0a,$0b,$0c,$1b,$1c,$22,$24,$25,$ff
print "locs_GreenPinkBrinstar: ", pc
locs_GreenPinkBrinstar:
	dw $11,$17,$1e,$21,$23,$0d,$0e,$0f,$10,$12,$13,$15,$16,$18,$19,$1f,$ff
print "locs_RedBrinstar: ", pc
locs_RedBrinstar:
	dw $26,$2a,$27,$28,$29,$ff
print "locs_WreckedShip: ", pc
locs_WreckedShip:
	dw $81,$84,$86,$87,$01,$02,$03,$80,$82,$83,$85,$ff
print "locs_Kraid: ", pc
locs_Kraid:
	dw $2b,$30,$2c,$ff
print "locs_Norfair: ", pc
locs_Norfair:
	dw $32,$35,$3d,$42,$44,$31,$33,$36,$37,$38,$3e,$3f,$40,$41,$43,$ff
print "locs_Crocomire: ", pc
locs_Crocomire:
	dw $34,$3c,$39,$3a,$3b,$ff
print "locs_LowerNorfair: ", pc
locs_LowerNorfair:
	dw $4e,$4f,$50,$46,$47,$49,$4a,$4b,$4c,$4d,$ff
print "locs_WestMaridia: ", pc
locs_WestMaridia:
	dw $8a,$88,$89,$8b,$8c,$8d,$8e,$ff
print "locs_EastMaridia: ", pc
locs_EastMaridia:
	dw $8f,$91,$96,$98,$9a,$90,$92,$93,$94,$95,$97,$ff
